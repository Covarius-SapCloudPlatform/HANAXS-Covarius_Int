(function() {
	...
	// Dimension, Measure and Amount fields dynamically based   //
	// on the parameters that have been passed in.              //
	// Dimensions, and Measure are expected to be on the Item   //
	// Table, while Value is expected to be on the Currency     //
	// Table.                                                   //
	//----------------------------------------------------------//
	...
	//Get the incoming Paramters
	var gvDimension = $.request.parameters.get('dimension');
	var gvMeasure = $.request.parameters.get('measure');
	var gvValue = $.request.parameters.get('value');
