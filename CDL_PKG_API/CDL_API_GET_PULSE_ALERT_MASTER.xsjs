(function() {
	...
	// from the Pulse Alert Master Table. Allowing              //
	...
	var gvTable = 'CDL_PULSE_ALERT_MASTER';
	var gvErrorMessage;
	...
	function _getEntries() {
		try {
			...
			while (oResultSet.next()) {
				...
				var record = {
					DATE: oResultSet.getString(1),
					TIME: oResultSet.getString(2),
					ALERT_ID: oResultSet.getString(3),
					RECIPIENT_EMAIL: oResultSet.getString(4),
					INTERFACE: oResultSet.getString(5),
					STATUS: oResultSet.getString(6)
				};
